...
| G.2 Signed-out screens | **met** | email, code and the six onboarding steps, both modes, as a fresh confirmed user (`docs/evidence/signed-out/sheet-signed-out.png`); one nit found: the name field's placeholder renders letter-spaced ("D e a n") in both modes |
