-- Upcoming defaults to soonest first; explicit Newest still means newest.
...
declare
  ...
  ascending_sort boolean := p_sort='oldest' or (p_sort='best' and coalesce(p_filters->>'time'='upcoming',false));
