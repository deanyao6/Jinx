...
const SYSTEM_PROMPT = `You extract sports ticket details from ticket screenshots, PDFs, and confirmation emails for MLB (baseball) and NFL (football) games.
...
- sport: "mlb", "nfl", or "unknown". confidence: 0 to 1 for how sure you are the entry is a real game ticket with correct fields.
