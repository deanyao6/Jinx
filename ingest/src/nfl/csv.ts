...
export function toPbpRow(r: RawRecord): NflversePbpRow {
  return {
    ...
    yards_gained: num(r, 'yards_gained'),
    total_home_score: num(r, 'total_home_score'),
    total_away_score: num(r, 'total_away_score'),
    td_team: str(r, 'td_team'),
    td_player_id: str(r, 'td_player_id'),
    td_player_name: str(r, 'td_player_name'),
    kicker_player_id: str(r, 'kicker_player_id'),
    kicker_player_name: str(r, 'kicker_player_name'),
