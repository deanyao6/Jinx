...
- Posts: the posts about your games (a caption and any photos you add), and the kudos and comments you leave on other people's posts. With auto-post on, a post about a game you logged goes up 30 minutes after it ends, and you have 15 minutes to edit or cancel it. You can turn auto-post off.
- Contacts, only if you allow it: your phone scrambles each contact's email addresses and phone numbers (a one-way hash, with a code we provide) and sends only the scrambled values. We compare them with the same scrambling of Jinx members' sign-in email and phone, tell your phone which ones match, and keep nothing: not the scrambled values and not the matches. Names and the rest of your address book never leave your phone. You can stop others finding you this way in Privacy.
...
**Your controls**: export everything from Settings as JSON, delete your account from Settings (removes all data and files), block, mute and report users, choose who sees your posts, and turn auto-post and contact matching off.
