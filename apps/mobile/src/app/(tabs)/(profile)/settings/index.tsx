...
/**
 * The doors the five-tab prototype moves under the gear (docs/prompts/social/01, section 1):
 * friends, communities, badges and four favorites. Communities, badges and four favorites are
 * placeholders until prompts 2 to 4 build them.
 */
export const circleRows: SettingsRow[] = [
  { title: 'Friends', meta: 'With, following, rivals', href: '/profile?panel=friends', icon: 'i-users' },
  { title: 'Communities', meta: 'Team and stadium fans', href: '/communities', icon: 'i-flag' },
  { title: 'Badges', meta: 'What you have earned', href: '/passport/badges', icon: 'i-verified' },
  {
    title: 'Four favorites',
    meta: 'The games at the top of your profile',
    href: '/passport/favorites',
    icon: 'i-spark',
  },
];
...
export default function SettingsRoute() {
  ...
  return (
    ...
    <SettingsFrame title="Settings" fallback="/profile">
      ...
      <SectionHeader title="Friends and collection" />
      <Card>
        {circleRows.map((row) => (
          <Row
            key={row.title}
